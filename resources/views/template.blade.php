...
<head>
  ...
  <!-- bootstrap core css -->
  <link rel="stylesheet" type="text/css" href="templatz/bootstrap.css" />
  ...
  <!-- font awesome style -->
  <link href="templatz/font-awesome.min.css" rel="stylesheet" />

  <!-- Custom styles for this template -->
  <link href="templatz/style.css" rel="stylesheet" />
  <!-- responsive style -->
  <link href="templatz/responsive.css" rel="stylesheet" />
...
<body>
    ...
    <section class="slider_section ">
      <div id="customCarousel1" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-categories active">
            <div class="container ">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class=" col-lg-10 mx-auto">
                      <div class="img-box">
                        <img src="templatz/slider-img.png" alt="">
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <section class="about_section layout_padding-bottom">
    <div class="container  ">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="templatz/about-img.png" alt="">
          </div>
        </div>
  ...
  <section class="server_section">
    <div class="container ">
      <div class="row">
        <div class="col-md-6">
          <div class="img-box">
            <img src="templatz/server-img.jpg" alt="">
            <div class="play_btn">
              <button>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-10 mx-auto">
                  <div class="box">
                    <div class="img-box">
                      <img src="templatz/client.jpg" alt="">
                    </div>
                    <div class="detail-box">
          ...
          <div class="info_link_box">
            ...
            <div class="info_links">
              <a class="active" href="index.html">
                <img src="templatz/nav-bullet.png" alt="">
                Home
              </a>
  ...
  <!-- jQery -->
  <script src="templatz/jquery-3.4.1.min.js"></script>
  <!-- bootstrap js -->
  <script src="templatz/bootstrap.js"></script>
  <!-- custom js -->
  <script src="templatz/custom.js"></script>
